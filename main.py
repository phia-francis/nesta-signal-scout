...
async def chat_endpoint(req: ChatRequest):
    ...
    try:
        ...
        prompt_parts = [
            ...
            "OUTPUT FORMATTING: 🛑 DO NOT generate text lists, bullet points, or Markdown blocks of signals.",
            "You MUST call the 'display_signal_card' tool for EACH signal you find.",
            "Visual Cards are the ONLY valid way to present signal data to the user.",
