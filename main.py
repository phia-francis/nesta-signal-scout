...
async def chat_endpoint(req: ChatRequest):
    ...
    try:
        ...
        prompt_parts = [
            ...
            "1. YOU CANNOT SPEAK. You have NO ability to output conversational text, summaries, or lists to the user.",
            "2. YOU CAN ONLY ACT. Your ONLY method of communication is calling the tool `display_signal_card`.",
            "3. IF YOU FIND A SIGNAL: You must immediately package it into the tool parameters and call `display_signal_card`.",
            "4. IF YOU OUTPUT BLOCK TEXT: You have FAILED the mission.",
